...
(function(factory) {
    ...
    function Plugin(element, options) {
        ...
        this.$extraSelect = $('<div class="' + this.options.extraSelectClass + '" />');
        this.$fill      = $('<div class="' + this.options.fillClass + '" />');
        this.$handle    = $('<div class="' + this.options.handleClass + '" />');
        this.$range     = $('<div class="' + this.options.rangeClass + '" id="' + this.identifier + '" />').insertAfter(this.$element).prepend(this.$extraSelect, this.$fill, this.$handle);
