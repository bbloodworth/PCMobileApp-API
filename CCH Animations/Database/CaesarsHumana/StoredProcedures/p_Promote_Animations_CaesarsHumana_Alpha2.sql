/****** Object:  StoredProcedure [dbo].[p_Promote_Animations_CaesarsHumana_alpha2]     ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[p_Promote_Animations_CaesarsHumana_alpha2]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[p_Promote_Animations_CaesarsHumana_alpha2]
GO
...
Execute:
      exec p_Promote_Animations_CaesarsHumana_alpha2
...
CREATE PROCEDURE [dbo].[p_Promote_Animations_CaesarsHumana_alpha2] 
as
...
INTO
	#CampaignDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.Campaign aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.Campaign 
...
INTO
	#ContentTypeDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.ContentType aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.ContentType 
...
INTO
	#ContentDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.Content aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.Content 
...
INTO
	#QuestionTypeDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.QuestionType aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.QuestionType 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.ContentStatus aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.ContentStatus 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.ContentDisplayRule aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.ContentDisplayRule 
...
INTO
	#AnswerDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.Answer aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.Answer 
...
INTO
	#QuestionDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.Question aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.Question 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.ExperienceEvent aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.ExperienceEvent 
...
INTO
	#AnimationDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.Animation aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.Animation 
...
INTO
	#VideoDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.Video aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.Video 
...
INTO
	#SurveyDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.Survey aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.Survey 
...
INTO
	#ResourceDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.Resource aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.Resource 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.RelatedContent aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.RelatedContent 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.SurveyQuestion aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.SurveyQuestion 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.QuestionAnswer aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.QuestionAnswer 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.ContentTypeState aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.ContentTypeState 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.UserContentPreference aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.UserContentPreference 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.CampaignContent aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.CampaignContent 
...
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.CampaignMember aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.CampaignMember 
...
INTO
	#UserContentDeletes
FROM
	alpha2.CCH_CaesarsHumanaWeb.dbo.UserContent aC
...
BEGIN	
	DELETE
		alpha2.CCH_CaesarsHumanaWeb.dbo.UserContent 
