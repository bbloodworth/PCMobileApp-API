/****** Object:  StoredProcedure [dbo].[p_Promote_Animations_Caesars_live]     ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[p_Promote_Animations_Caesars_live]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[p_Promote_Animations_Caesars_live]
GO
...
Execute:
      exec p_Promote_Animations_Caesars_live
...
CREATE PROCEDURE [dbo].[p_Promote_Animations_Caesars_live] 
as
...
INTO
	#CampaignDeletes
FROM
	live.cch_caesarsweb.dbo.Campaign aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.Campaign 
...
INTO
	#ContentTypeDeletes
FROM
	live.cch_caesarsweb.dbo.ContentType aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.ContentType 
...
INTO
	#ContentDeletes
FROM
	live.cch_caesarsweb.dbo.Content aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.Content 
...
INTO
	#QuestionTypeDeletes
FROM
	live.cch_caesarsweb.dbo.QuestionType aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.QuestionType 
...
FROM
	live.cch_caesarsweb.dbo.ContentStatus aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.ContentStatus 
...
FROM
	live.cch_caesarsweb.dbo.ContentDisplayRule aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.ContentDisplayRule 
...
INTO
	#AnswerDeletes
FROM
	live.cch_caesarsweb.dbo.Answer aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.Answer 
...
INTO
	#QuestionDeletes
FROM
	live.cch_caesarsweb.dbo.Question aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.Question 
...
FROM
	live.cch_caesarsweb.dbo.ExperienceEvent aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.ExperienceEvent 
...
INTO
	#AnimationDeletes
FROM
	live.cch_caesarsweb.dbo.Animation aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.Animation 
...
INTO
	#VideoDeletes
FROM
	live.cch_caesarsweb.dbo.Video aC
...
INTO
	#SurveyDeletes
FROM
	live.cch_caesarsweb.dbo.Survey aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.Survey 
...
INTO
	#ResourceDeletes
FROM
	live.cch_caesarsweb.dbo.Resource aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.Resource 
...
FROM
	live.cch_caesarsweb.dbo.RelatedContent aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.RelatedContent 
...
FROM
	live.cch_caesarsweb.dbo.SurveyQuestion aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.SurveyQuestion 
...
FROM
	live.cch_caesarsweb.dbo.QuestionAnswer aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.QuestionAnswer 
...
FROM
	live.cch_caesarsweb.dbo.ContentTypeState aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.ContentTypeState 
...
FROM
	live.cch_caesarsweb.dbo.UserContentPreference aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.UserContentPreference 
...
FROM
	live.cch_caesarsweb.dbo.CampaignContent aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.CampaignContent 
...
FROM
	live.cch_caesarsweb.dbo.CampaignMember aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.CampaignMember 
...
INTO
	#UserContentDeletes
FROM
	live.cch_caesarsweb.dbo.UserContent aC
...
BEGIN	
	DELETE
		live.cch_caesarsweb.dbo.UserContent 
