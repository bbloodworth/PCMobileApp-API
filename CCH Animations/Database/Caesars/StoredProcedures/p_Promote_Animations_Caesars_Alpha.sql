/****** Object:  StoredProcedure [dbo].[p_Promote_Animations_Caesars_alpha]     ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[p_Promote_Animations_Caesars_alpha]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[p_Promote_Animations_Caesars_alpha]
GO
...
Execute:
      exec p_Promote_Animations_Caesars_alpha
...
CREATE PROCEDURE [dbo].[p_Promote_Animations_Caesars_alpha] 
as
...
INTO
	#CampaignDeletes
FROM
	alpha.cch_caesarsweb.dbo.Campaign aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.Campaign 
...
INTO
	#ContentTypeDeletes
FROM
	alpha.cch_caesarsweb.dbo.ContentType aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.ContentType 
...
INTO
	#ContentDeletes
FROM
	alpha.cch_caesarsweb.dbo.Content aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.Content 
...
INTO
	#QuestionTypeDeletes
FROM
	alpha.cch_caesarsweb.dbo.QuestionType aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.QuestionType 
...
FROM
	alpha.cch_caesarsweb.dbo.ContentStatus aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.ContentStatus 
...
FROM
	alpha.cch_caesarsweb.dbo.ContentDisplayRule aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.ContentDisplayRule 
...
INTO
	#AnswerDeletes
FROM
	alpha.cch_caesarsweb.dbo.Answer aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.Answer 
...
INTO
	#QuestionDeletes
FROM
	alpha.cch_caesarsweb.dbo.Question aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.Question 
...
FROM
	alpha.cch_caesarsweb.dbo.ExperienceEvent aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.ExperienceEvent 
...
INTO
	#AnimationDeletes
FROM
	alpha.cch_caesarsweb.dbo.Animation aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.Animation 
...
INTO
	#VideoDeletes
FROM
	alpha.cch_caesarsweb.dbo.Video aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.Video 
...
INTO
	#SurveyDeletes
FROM
	alpha.cch_caesarsweb.dbo.Survey aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.Survey 
...
INTO
	#ResourceDeletes
FROM
	alpha.cch_caesarsweb.dbo.Resource aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.Resource 
...
FROM
	alpha.cch_caesarsweb.dbo.RelatedContent aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.RelatedContent 
...
FROM
	alpha.cch_caesarsweb.dbo.SurveyQuestion aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.SurveyQuestion 
...
FROM
	alpha.cch_caesarsweb.dbo.QuestionAnswer aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.QuestionAnswer 
...
FROM
	alpha.cch_caesarsweb.dbo.ContentTypeState aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.ContentTypeState 
...
FROM
	alpha.cch_caesarsweb.dbo.UserContentPreference aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.UserContentPreference 
...
FROM
	alpha.cch_caesarsweb.dbo.CampaignContent aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.CampaignContent 
...
FROM
	alpha.cch_caesarsweb.dbo.CampaignMember aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.CampaignMember 
...
INTO
	#UserContentDeletes
FROM
	alpha.cch_caesarsweb.dbo.UserContent aC
...
BEGIN	
	DELETE
		alpha.cch_caesarsweb.dbo.UserContent 
