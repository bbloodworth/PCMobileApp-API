/****** Object:  StoredProcedure [dbo].[p_Promote_Animations_Caesars_alpha2]     ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[p_Promote_Animations_Caesars_alpha2]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[p_Promote_Animations_Caesars_alpha2]
GO
...
Execute:
      exec p_Promote_Animations_Caesars_alpha2
...
CREATE PROCEDURE [dbo].[p_Promote_Animations_Caesars_alpha2] 
as

BEGIN --proc

IF  @@servername = 'SAMB01VMD01' AND db_name() = 'CCH_CaesarsWeb'
BEGIN --Env
----------------------------------------------------------------------------
...
INTO
	#CampaignDeletes
FROM
	alpha2.cch_caesarsweb.dbo.Campaign aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.Campaign 
...
INTO
	#ContentTypeDeletes
FROM
	alpha2.cch_caesarsweb.dbo.ContentType aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.ContentType 
...
INTO
	#ContentDeletes
FROM
	alpha2.cch_caesarsweb.dbo.Content aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.Content 
...
INTO
	#QuestionTypeDeletes
FROM
	alpha2.cch_caesarsweb.dbo.QuestionType aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.QuestionType 
...
FROM
	alpha2.cch_caesarsweb.dbo.ContentStatus aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.ContentStatus 
...
FROM
	alpha2.cch_caesarsweb.dbo.ContentDisplayRule aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.ContentDisplayRule 
...
INTO
	#AnswerDeletes
FROM
	alpha2.cch_caesarsweb.dbo.Answer aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.Answer 
...
INTO
	#QuestionDeletes
FROM
	alpha2.cch_caesarsweb.dbo.Question aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.Question 
...
FROM
	alpha2.cch_caesarsweb.dbo.ExperienceEvent aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.ExperienceEvent 
...
INTO
	#AnimationDeletes
FROM
	alpha2.cch_caesarsweb.dbo.Animation aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.Animation 
...
INTO
	#VideoDeletes
FROM
	alpha2.cch_caesarsweb.dbo.Video aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.Video 
...
INTO
	#SurveyDeletes
FROM
	alpha2.cch_caesarsweb.dbo.Survey aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.Survey 
...
INTO
	#ResourceDeletes
FROM
	alpha2.cch_caesarsweb.dbo.Resource aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.Resource 
...
FROM
	alpha2.cch_caesarsweb.dbo.RelatedContent aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.RelatedContent 
...
FROM
	alpha2.cch_caesarsweb.dbo.SurveyQuestion aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.SurveyQuestion 
...
FROM
	alpha2.cch_caesarsweb.dbo.QuestionAnswer aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.QuestionAnswer 
...
FROM
	alpha2.cch_caesarsweb.dbo.ContentTypeState aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.ContentTypeState 
...
FROM
	alpha2.cch_caesarsweb.dbo.UserContentPreference aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.UserContentPreference 
...
FROM
	alpha2.cch_caesarsweb.dbo.CampaignContent aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.CampaignContent 
...
FROM
	alpha2.cch_caesarsweb.dbo.CampaignMember aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.CampaignMember 
...
INTO
	#UserContentDeletes
FROM
	alpha2.cch_caesarsweb.dbo.UserContent aC
...
BEGIN	
	DELETE
		alpha2.cch_caesarsweb.dbo.UserContent 
