/****** Object:  StoredProcedure [dbo].[p_Promote_Animations_CaesarsHorizon_alpha2]     ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[p_Promote_Animations_CaesarsHorizon_alpha2]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[p_Promote_Animations_CaesarsHorizon_alpha2]
GO
...
Execute:
      exec p_Promote_Animations_CaesarsHorizon_alpha2
...
CREATE PROCEDURE [dbo].[p_Promote_Animations_CaesarsHorizon_alpha2] 
as

BEGIN

IF  @@servername = 'SAMB01VMD01' AND db_name() = 'CCH_CaesarsHorizonWeb'
BEGIN --Env
----------------------------------------------------------------------------
...
INTO
	#CampaignDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.Campaign aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.Campaign 
...
INTO
	#ContentTypeDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.ContentType aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.ContentType 
...
INTO
	#ContentDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.Content aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.Content 
...
INTO
	#QuestionTypeDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.QuestionType aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.QuestionType 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.ContentStatus aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.ContentStatus 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.ContentDisplayRule aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.ContentDisplayRule 
...
INTO
	#AnswerDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.Answer aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.Answer 
...
INTO
	#QuestionDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.Question aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.Question 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.ExperienceEvent aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.ExperienceEvent 
...
INTO
	#AnimationDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.Animation aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.Animation 
...
INTO
	#VideoDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.Video aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.Video 
...
INTO
	#SurveyDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.Survey aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.Survey 
...
INTO
	#ResourceDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.Resource aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.Resource 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.RelatedContent aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.RelatedContent 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.SurveyQuestion aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.SurveyQuestion 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.QuestionAnswer aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.QuestionAnswer 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.ContentTypeState aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.ContentTypeState 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.UserContentPreference aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.UserContentPreference 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.CampaignContent aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.CampaignContent 
...
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.CampaignMember aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.CampaignMember 
...
INTO
	#UserContentDeletes
FROM
	alpha2.cch_CaesarsHorizonWeb.dbo.UserContent aC
...
BEGIN	
	DELETE
		alpha2.cch_CaesarsHorizonWeb.dbo.UserContent 
