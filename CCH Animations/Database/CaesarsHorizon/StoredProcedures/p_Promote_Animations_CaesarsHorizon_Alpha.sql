/****** Object:  StoredProcedure [dbo].[p_Promote_Animations_CaesarsHorizon_alpha]     ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[p_Promote_Animations_CaesarsHorizon_alpha]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[p_Promote_Animations_CaesarsHorizon_alpha]
GO
...
Execute:
      exec p_Promote_Animations_CaesarsHorizon_alpha
...
CREATE PROCEDURE [dbo].[p_Promote_Animations_CaesarsHorizon_alpha] 
as
...
INTO
	#CampaignDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.Campaign aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.Campaign 
...
INTO
	#ContentTypeDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.ContentType aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.ContentType 
...
INTO
	#ContentDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.Content aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.Content 
...
INTO
	#QuestionTypeDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.QuestionType aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.QuestionType 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.ContentStatus aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.ContentStatus 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.ContentDisplayRule aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.ContentDisplayRule 
...
INTO
	#AnswerDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.Answer aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.Answer 
...
INTO
	#QuestionDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.Question aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.Question 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.ExperienceEvent aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.ExperienceEvent 
...
INTO
	#AnimationDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.Animation aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.Animation 
...
INTO
	#VideoDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.Video aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.Video 
...
INTO
	#SurveyDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.Survey aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.Survey 
...
INTO
	#ResourceDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.Resource aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.Resource 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.RelatedContent aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.RelatedContent 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.SurveyQuestion aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.SurveyQuestion 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.QuestionAnswer aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.QuestionAnswer 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.ContentTypeState aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.ContentTypeState 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.UserContentPreference aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.UserContentPreference 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.CampaignContent aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.CampaignContent 
...
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.CampaignMember aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.CampaignMember 
...
INTO
	#UserContentDeletes
FROM
	alpha.cch_CaesarsHorizonWeb.dbo.UserContent aC
...
BEGIN	
	DELETE
		alpha.cch_CaesarsHorizonWeb.dbo.UserContent 
