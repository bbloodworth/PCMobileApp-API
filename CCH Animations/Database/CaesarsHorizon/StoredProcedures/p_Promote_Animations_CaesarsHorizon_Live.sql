/****** Object:  StoredProcedure [dbo].[p_Promote_Animations_CaesarsHorizon_live]     ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[p_Promote_Animations_CaesarsHorizon_live]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[p_Promote_Animations_CaesarsHorizon_live]
GO
...
Execute:
      exec p_Promote_Animations_CaesarsHorizon_live
...
CREATE PROCEDURE [dbo].[p_Promote_Animations_CaesarsHorizon_live] 
as
...
INTO
	#CampaignDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.Campaign aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.Campaign 
...
INTO
	#ContentTypeDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.ContentType aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.ContentType 
...
INTO
	#ContentDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.Content aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.Content 
...
INTO
	#QuestionTypeDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.QuestionType aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.QuestionType 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.ContentStatus aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.ContentStatus 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.ContentDisplayRule aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.ContentDisplayRule 
...
INTO
	#AnswerDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.Answer aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.Answer 
...
INTO
	#QuestionDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.Question aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.Question 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.ExperienceEvent aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.ExperienceEvent 
...
INTO
	#AnimationDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.Animation aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.Animation 
...
INTO
	#VideoDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.Video aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.Video 
...
INTO
	#SurveyDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.Survey aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.Survey 
...
INTO
	#ResourceDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.Resource aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.Resource 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.RelatedContent aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.RelatedContent 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.SurveyQuestion aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.SurveyQuestion 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.QuestionAnswer aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.QuestionAnswer 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.ContentTypeState aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.ContentTypeState 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.UserContentPreference aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.UserContentPreference 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.CampaignContent aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.CampaignContent 
...
FROM
	live.cch_CaesarsHorizonWeb.dbo.CampaignMember aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.CampaignMember 
...
INTO
	#UserContentDeletes
FROM
	live.cch_CaesarsHorizonWeb.dbo.UserContent aC
...
BEGIN	
	DELETE
		live.cch_CaesarsHorizonWeb.dbo.UserContent 
