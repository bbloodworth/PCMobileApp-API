/****** Object:  StoredProcedure [dbo].[p_Promote_Animations_Avaya_alpha]     ******/
USE CCH_AvayaWeb
GO

IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[p_Promote_Animations_Avaya_alpha]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[p_Promote_Animations_Avaya_alpha]
GO
...
Execute:
      exec p_Promote_Animations_Avaya_alpha
...
CREATE PROCEDURE [dbo].[p_Promote_Animations_Avaya_alpha] 
as

BEGIN --proc

IF  @@servername = 'SAMB01VMD01' AND db_name() = 'CCH_AvayaWeb'
BEGIN --Env
----------------------------------------------------------------------------
...
INTO
	#CampaignDeletes
FROM
	alpha.cch_Avayaweb.dbo.Campaign aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.Campaign 
...
INTO
	#ContentTypeDeletes
FROM
	alpha.cch_Avayaweb.dbo.ContentType aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.ContentType 
...
INTO
	#ContentDeletes
FROM
	alpha.cch_Avayaweb.dbo.Content aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.Content 
...
INTO
	#QuestionTypeDeletes
FROM
	alpha.cch_Avayaweb.dbo.QuestionType aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.QuestionType 
...
FROM
	alpha.cch_Avayaweb.dbo.ContentStatus aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.ContentStatus 
...
FROM
	alpha.cch_Avayaweb.dbo.ContentDisplayRule aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.ContentDisplayRule 
...
INTO
	#AnswerDeletes
FROM
	alpha.cch_Avayaweb.dbo.Answer aC
...
INTO
	#QuestionDeletes
FROM
	alpha.cch_Avayaweb.dbo.Question aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.Question 
...
FROM
	alpha.cch_Avayaweb.dbo.ExperienceEvent aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.ExperienceEvent 
...
INTO
	#AnimationDeletes
FROM
	alpha.cch_Avayaweb.dbo.Animation aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.Animation 
...
INTO
	#VideoDeletes
FROM
	alpha.cch_Avayaweb.dbo.Video aC
...
INTO
	#SurveyDeletes
FROM
	alpha.cch_Avayaweb.dbo.Survey aC
...
INTO
	#ResourceDeletes
FROM
	alpha.cch_Avayaweb.dbo.Resource aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.Resource 
...
FROM
	alpha.cch_Avayaweb.dbo.RelatedContent aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.RelatedContent 
...
FROM
	alpha.cch_Avayaweb.dbo.SurveyQuestion aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.SurveyQuestion 
...
FROM
	alpha.cch_Avayaweb.dbo.QuestionAnswer aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.QuestionAnswer 
...
FROM
	alpha.cch_Avayaweb.dbo.ContentTypeState aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.ContentTypeState 
...
FROM
	alpha.cch_Avayaweb.dbo.UserContentPreference aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.UserContentPreference 
...
FROM
	alpha.cch_Avayaweb.dbo.CampaignContent aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.CampaignContent 
...
FROM
	alpha.cch_Avayaweb.dbo.CampaignMember aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.CampaignMember 
...
INTO
	#UserContentDeletes
FROM
	alpha.cch_Avayaweb.dbo.UserContent aC
...
BEGIN	
	DELETE
		alpha.cch_Avayaweb.dbo.UserContent 
