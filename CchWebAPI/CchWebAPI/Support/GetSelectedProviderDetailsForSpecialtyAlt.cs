...
namespace CchWebAPI.Support
{
    ...
    public sealed class GetSelectedProviderDetailsForSpecialtyAlt : DataBase
    {
        ...
        public GetSelectedProviderDetailsForSpecialtyAlt()
            : base("GetSelectedProviderDetailsForSpecialty_Alt")
        {
            ...
            this.Parameters.New("OrganizationLocationID", System.Data.SqlDbType.NVarChar, 25);
        ...
        public override void GetData(string connectionString)
        {
            ...
            if (this.Tables.Count >= 3 && this.Tables[2].Rows.Count > 0)
                healthGradesInfo = (from hgi in this.Tables[2].AsEnumerable()
                                    where !(hgi.Field<dynamic>("Office") == null && 
                                            hgi.Field<dynamic>("Procedures") == null)
                                    select new
                                    {
